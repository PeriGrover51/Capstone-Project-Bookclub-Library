...
export default function MeetingCard({ meeting }) {
    ...
    return (
        <div className="w-150 lg:flex flex-none">
            ...
            <div className="border border-gray-400 bg-gray-100 lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                <div className="mb-6">
                    <div className="text-gray-900 font-bold text-xl mb-2">{meeting.book.title} by {meeting.book.author}</div>
                    <p className="text-gray-700 text-base">{meeting.readingGoal}</p>
                    <p className="text-gray-700 text-base">{meeting.meetingNotes}</p>
                </div>

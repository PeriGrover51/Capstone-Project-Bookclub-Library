...
export default function DeleteAll() {
    ...
    return (
        <div className="max-w-lg mx-auto mt-8 mb-8 p-8 library-card text-center font-bold text-red-900">
            <div className="m-4 uppercase text-4xl">Clear All Nominations</div>
